...
const resumeData = {
  ...
  contact: {
    ...
    phone: "+91 9361589969",
    address:
      "No5 Prasanna vinayagar kovil street,First lane mylapore, Chennai-600 004,Tamilnadu,",
  },
  summary:
    "Experienced Full stack developer with a passion for creating innovative apps. Skilled in web app development.",
  education: [
    {
  ...
  interests: ["Full stack app development", "Open-source app development"],
};
